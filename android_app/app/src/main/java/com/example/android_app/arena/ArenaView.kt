 ...
 *
 * Checklist coverage:
 *   C.5  2D display of arena with obstacles (numbered) and robot with facing
 *   C.6  Touch-place, drag-move, drag-off-map delete of obstacles
 *   C.7  Long-press an obstacle to open the face annotation dialog
 *   C.9  Target ID display (set via [setTargetId])
 *   C.10 Robot pose update (set via [setRobot])
 *
 * Callbacks:
