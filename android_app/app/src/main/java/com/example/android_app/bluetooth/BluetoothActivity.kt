...
/**
 * Bluetooth device scan/select/connect screen.
 *
 * Checklist:
 *   C.1  Bi-directional text send/receive over RFCOMM (send box + inbound log)
 *   C.2  Scan, select, connect to a bluetooth device from a live list
 *   C.8  Reconnection is handled by [BluetoothService]; the UI reflects it
 */
