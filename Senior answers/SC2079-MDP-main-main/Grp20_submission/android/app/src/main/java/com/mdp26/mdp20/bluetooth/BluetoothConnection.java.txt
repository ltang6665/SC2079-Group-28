...
public class BluetoothConnection {
    ...
    private final DataStreamTask dataStreamTask;

    public BluetoothConnection(Context context, BluetoothSocket socket, BluetoothDevice device) {
        this.appContext = context.getApplicationContext(); 
        dataStreamTask = new DataStreamTask(socket, device);
    }

    public void start() {
        dataStreamTask.start();
    }
    ...
    private class DataStreamTask extends Thread {
        private static final String TAG = "DataStreamTask";
        ...
        public DataStreamTask(BluetoothSocket socket, BluetoothDevice device) {
